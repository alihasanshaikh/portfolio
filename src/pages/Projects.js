...
const Projects = () => {
  ...
  const filteredProjects = activeCategory === "All" 
    ...
    : [...featuredProjects, ...additionalProjects].filter(project => project.category === activeCategory);
  ...
  return (
    <div>
      ...
      <div className="pt-5 mt-5 container container-fluid">
        ...
        {/* Additional Projects */}
        {additionalProjects.filter(project => activeCategory === "All" || project.category === activeCategory).length > 0 && (
          <div className="mb-5">
            ...
            <div className="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
              {additionalProjects
                ...
                <div className="col" key={project.id}>
                  <div 
                    className="card shadow h-100 rounded-3 border-0"
                    data-aos="fade-up"
                    data-aos-delay={index * 50}
                  >
                    <div className="card-body d-flex flex-column">
                      <div className="d-flex justify-content-between align-items-start mb-3">
                        <h5 className="card-title text-primary fw-bold mb-0">{project.title}</h5>
